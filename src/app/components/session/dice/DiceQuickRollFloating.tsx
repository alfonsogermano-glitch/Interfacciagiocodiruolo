...
export function DiceQuickRollFloating(){
 ...
 return <div className="fixed bottom-5 left-28 z-[945] flex items-center gap-2" data-dice-quick-roll-floating>
  ...
  {open&&<div data-dice-quick-palette className="flex min-w-0 max-w-[calc(100vw-20rem)] select-none flex-nowrap items-center gap-2 overflow-x-auto rounded-2xl border border-[var(--dash-border)] bg-[var(--dash-panel)]/95 px-2 py-1 shadow-2xl backdrop-blur-md caret-transparent [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
