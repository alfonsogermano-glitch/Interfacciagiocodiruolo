...
export const ICE_TEXTURE_SOURCE_DATA_URL = `data:image/webp;base64,${ICE_TEXTURE_CHUNK_0}${ICE_TEXTURE_CHUNK_1}${ICE_TEXTURE_CHUNK_2}${ICE_TEXTURE_CHUNK_3}${ICE_TEXTURE_CHUNK_4}${ICE_TEXTURE_CHUNK_5}`;
