...
// The GitHub transport for this embedded shard dropped one base64 character.
...
export const LIGHTNING_TEXTURE_SOURCE_DATA_URL = `data:image/webp;base64,${LIGHTNING_TEXTURE_CHUNK_0}${LIGHTNING_TEXTURE_CHUNK_1}${LIGHTNING_TEXTURE_CHUNK_2}${LIGHTNING_TEXTURE_CHUNK_3}${LIGHTNING_TEXTURE_CHUNK_4}${LIGHTNING_TEXTURE_CHUNK_5_APPROVED}${LIGHTNING_TEXTURE_CHUNK_6}${LIGHTNING_TEXTURE_CHUNK_7}`;
