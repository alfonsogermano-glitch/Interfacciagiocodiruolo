...
const completed = completeStandardDiceStyles([{ ...defaults[0], sides: 4, skinId: 'fire', effectsEnabled: true }]);
...
const styles: StandardDieAppearance[] = defaults.map((style) => style.sides === 6 ? {...style, bodyColor:'#123456', symbolColor:'#abcdef', skinId:'arcane', effectsEnabled:true} : style);
...
assert.deepEqual(snap.diceGroups[0].appearance, {bodyColor:'#123456',symbolColor:'#abcdef',skinId:'arcane',effectsEnabled:true});
