...
assert.ok(d4Block.indexOf('factory.materials_cache = {};') < d4Block.indexOf('shouldBoostDice3DLabelOutline(descriptor)'), 'd4 material cache must be cleared before upstream face regeneration');
