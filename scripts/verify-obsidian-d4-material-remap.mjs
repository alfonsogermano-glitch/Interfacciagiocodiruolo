...
assert.ok(d4Block.includes("applyStaticSkinToMesh(dicemesh, descriptor, 'd4');"), 'd4 remap must restore static skin material tuning through the d4-safe path after upstream regeneration');
