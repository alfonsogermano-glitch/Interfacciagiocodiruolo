...
assert.match(categoryIcon, /left:\s*iconName === 'Cog' \? '-0\.22em' : '-0\.12em'[\s\S]*bottom:\s*'-0\.3em'[\s\S]*opacity:\s*'0\.5'[\s\S]*pointerEvents:\s*'none'/, 'category icons must sit discreetly behind the content in the lower-left corner');
