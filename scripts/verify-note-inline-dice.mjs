...
assert.match(dice, /noteCustomDieQuantity[\s\S]*fontSize: '2em'[\s\S]*noteCustomDieFace[\s\S]*CustomDieLibraryIcon/, 'the widget must place an equally prominent quantity before the selected Custom face');
