...
assert.match(editor, /peerContents/, 'editors must receive peer tab documents for references');
assert.match(noteSubTabs, /peerContents=\{/, 'note subtabs must feed peer documents to the editor');
